# FLUO4_ALIGNMENT
align_v2.py Per-well TH mask -> Fluo-4 alignment, scored, with an auditable pass/fail per well and the region growth moved OUT of Harmony and INTO the mask. 
